...
| 25  | `.Element{}`            | In CSS, `.Element{}` is used to define a class selector that applies styles to all elements with the specified class.                                                                                 |
| 26  | `background-color`      | In CSS, the `background-color` property is used to set the background color of an element.                                                                                                            |
| 27  | `color`                 | In CSS, the `color` property is used to set the text color of an element.                                                                                                                             |
| 28  | `border`                | In CSS, the `border` property is used to set the border around an element.                                                                                                                            |
| 29  | `height`                | In CSS, the `height` property is used to define the height of an element.                                                                                                                             |
| 30  | `width`                 | In CSS, the `width` property is used to define the width of an element.                                                                                                                               |
| 31  | `border-radius`         | In CSS, the `border-radius` property is used to round the corners of an element's border.                                                                                                             |
| 32  | `cursor`                | In CSS, the `cursor` property is used to specify the type of cursor to be displayed when pointing over an element.                                                                                    |
| 33  | `border-color`          | In CSS, the `border-color` property is used to specify the color of an element's border.                                                                                                              |
| 34  | `border-style`          | In CSS, the `border-style` property is used to define the style of the border, such as solid, dashed, or dotted.                                                                                      |
| 35  | `border-width`          | In CSS, the `border-width` property is used to specify the width of an element's border.                                                                                                              |
| 36  | `margin-right`          | In CSS, the `margin-right` property is used to specify the right margin space of an element.                                                                                                          |
| 37  | `font-weight`           | In CSS, the `font-weight` property is used to specify the thickness or boldness of the font.                                                                                                          |
| 38  | `font-size`             | In CSS, the `font-size` property is used to set the size of the text.                                                                                                                                 |
| 39  | `margin-left`           | In CSS, the `margin-left` property is used to specify the left margin space of an element.                                                                                                            |
| 40  | `hover`                 | In CSS, `hover` is a pseudo-class used to define the style of an element when the mouse is over it.                                                                                                   |
| 41  | `.element:pseudo class` | In CSS, `.element:pseudo class` is used to define styles for an element when it is in a specific state, such as `:hover`.                                                                             |
| 42  | `opacity`               | In CSS, the `opacity` property is used to define the transparency level of an element.                                                                                                                |
| 43  | `transition`            | In CSS, the `transition` property is used to define the transition effects when a CSS property changes from one state to another.                                                                     |
| 44  | `box-shadow`            | In CSS, the `box-shadow` property is used to add shadow effects around an element's frame.                                                                                                            |
| 45  | `rgba`                  | In CSS, the `rgba` color value is used to define colors with red, green, blue, and alpha (opacity) channels.                                                                                          |
| 46  | `padding`               | In CSS, the `padding` property is used to generate space around an element's content, inside of any defined borders.                                                                                  |
| 47  | `vertical-align`        | In CSS, the `vertical-align` property is used to align the vertical position of an inline or table-cell element.                                                                                      |
| 48  | `dirrection`            | In CSS, the `direction` property is used to set the text direction, such as left-to-right or right-to-left.                                                                                           |
| 49  | `font-family`           | In CSS, the `font-family` property is used to define the font of an element's text.                                                                                                                   |
| 50  | `line-height`           | In CSS, the `line-height` property is used to set the amount of space between lines of text.                                                                                                          |
| 51  | `html entity`           | In CSS, an HTML entity is used to display reserved characters, such as `&amp;` for `&`.                                                                                                               |
| 52  | `text-align`            | In CSS, the `text-align` property is used to set the horizontal alignment of text within an element.                                                                                                  |
| 53  | `CSS specificity`       | In CSS, specificity determines which CSS rule is applied by the browser when multiple rules could apply to the same element.                                                                          |
| 54  | `font-style`            | In CSS, the `font-style` property is used to set the style of the text, such as normal, italic, or oblique.                                                                                           |
| 55  | `text-decoration`       | In CSS, the `text-decoration` property is used to set the decoration on text, such as underline, overline, or line-through.                                                                           |
| 56  | `!`                     |                                                                                                                                                                                                       |
| 57  | `<img>`                 |                                                                                                                                                                                                       |
| 58  | `src`                   |                                                                                                                                                                                                       |
| 59  | `object-fit`            |                                                                                                                                                                                                       |
