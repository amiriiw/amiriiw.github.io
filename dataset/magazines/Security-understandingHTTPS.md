...
Certbot will automatically configure your web server to use the certificate. 4. **Auto-Renewal:** Let's Encrypt certificates are valid for 90 days. Certbot automatically renews them, but you should ensure that the renewal process is working correctly:
